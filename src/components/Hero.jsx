...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set("#video-frame", {
      clipPath: 'polygon(20% 0%, 78% 17%, 75% 61%, 19% 76%)',
      ...
      >
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            <p className="mb-5 w-7xl font-robert-regular text-white">
              Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius blanditiis eos <br />maxime quaerat ut fugit facilis numquam ad dolores enim?
            </p>
